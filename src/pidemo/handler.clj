(ns pidemo.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [pidemo.routes.home :refer [home-routes]]
            [pidemo.routes.services :refer [service-routes]]
            [pidemo.middleware :as middleware]
            [pidemo.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "pidemo is shutting down...")
  (stop-nrepl)
